...
export default function Register() {
    ...
    return (
        <>
            <Head>
                <title>Sign up to Next - Minimal - Tailwind</title>
            </Head>
                    ...
                    <div className="flex flex-col space-y-6">
                        ...
                        <div className="text-gray-600 flex flex-col space-y-1">
                            ...
                            <div className="flex flex-row w-full justify-between">
                                <button
                                    className="group flex justify-center items-center text-gray-500 border border-gray-300 shadow-sm p-1 px-10 rounded-md">
                                    <svg
                                        width={25}
                                        height={25}
                                        fill="currentColor"
                ...
                Or continue with
                        ...
                        <form className="space-y-2" action="#" method="POST">
                            ...
                            {validEmail ? (
                                ...
                                <div
                                    className="focus-within:ring-2 focus-within:ring-red-300 focus-within:border-red-300 flex flex-row text-gray-400 focus-within:text-gray-600 transition-colors duration-200 rounded-md relative w-full px-3 py-2 border border-gray-300">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width={20}
                                        height={20}
