...
const ProductForm = () => {
    ...
    return (
        <>
            <div
                className="relative flex flex-col p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-500 select-none">
              ...
              <span className="text-gray-500 sm:text-sm">
                ...
                <div className="mt-6">
                    <div
                        className="relative flex w-full pl-3.5 py-2 pr-12 sm:text-sm border border-gray-300 rounded-md justify-between">
                ...
                <div className="mt-4">
                    ...
                    <div
                        className="relative flex w-full pl-3.5 py-2 pr-12 sm:text-sm border border-gray-300 rounded-md">
                ...
                <div className="flex flex-row-reverse mt-4 space-x-4 space-x-reverse">
                    ...
                    <button
                        className="focus:outline-none focus:ring-2 focus:ring-indigo-300 text-gray-400 font-medium rounded-md p-2 px-6">
                        Cancel
                    </button>
                </div>
            </div>
