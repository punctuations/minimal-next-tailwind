    ...
    return (
        <section className="flex flex-col justify-center items-center space-y-6">
            <form className="grid grid-cols-2 grid-rows-6 gap-x-5 gap-y-3">
                <div
                    className="focus-within:ring-2 focus-within:ring-indigo-500 focus-within:border-indigo-500 flex flex-row text-gray-400 focus-within:text-gray-600 transition-colors duration-200 rounded-md relative w-full px-3 py-2 border border-gray-300">
                    <svg
                ...
                <div
                    className="col-span-2 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:border-indigo-500 flex flex-row text-gray-400 focus-within:text-gray-600 transition-colors duration-200 rounded-md relative w-full px-3 py-2 border border-gray-300">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width={20}
                        height={20}
                ...
                <div
                    className="col-span-2 row-span-6 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:border-indigo-500 flex flex-row text-gray-400 focus-within:text-gray-600 transition-colors duration-200 rounded-md relative w-full px-3 py-2 border border-gray-300">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width={20}
                        height={20}
